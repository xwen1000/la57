  ...
  <div class="login-box-body">
    ...
    <form action="{{ admin_base_path('auth/login') }}" method="post">
      ...
      <div class="form-group has-feedback {!! !$errors->has('captcha') ?: 'has-error' !!}">
        ...
        <input type="text" class="form-control" style="display: inline; width: 61%;" placeholder="{{ trans('admin.captcha') }}" name="captcha">
        <span class="glyphicon glyphicon-refresh form-control-feedback" style="right: 39%;"></span>
        <img  class="captcha" src="{{ captcha_src('admin') }}" style="cursor: pointer;" onclick="refresh()">
        <script>
          function refresh(){
